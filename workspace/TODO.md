...
<todo id="weather-map">
Add interactive weather radar/map page
Integrate OpenWeatherMap tiles or a free rain radar overlay with a lightweight map library
</todo>

<todo id="alerts-system">
Build live weather alert system
Fetch severe weather warnings from MET Norway alerts API and display with severity-coded banners
</todo>
