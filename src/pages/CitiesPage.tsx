...
export const CitiesPage: React.FC = () => {
  ...
  return (
    <main id="main-content" className="max-w-7xl mx-auto px-4 md:px-6 pb-28 md:pb-12 pt-6">
      {/* Breadcrumb */}
      <nav aria-label="Shtegun navigimi" className="flex items-center gap-1 text-xs text-white/70 mb-6">
      ...
      <p className="text-white/70 text-sm mb-8">Parashikimi i motit për çdo qytet dhe vendbanim shqiptar</p>
            ...
            {cities.map((city) => (
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-white/65 text-xs truncate">{city.region}</div>
                </div>
